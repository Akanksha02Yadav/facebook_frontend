      ...
      <div className="register">
        ...
        <Formik
          ...
          onSubmit={() => {
            ...
            let notMoreThan70 = new Date(1970 + 70, 0, 1);
            if (current_date - picked_date < atleast14) {
              setDateError(
                "Its looks like you've entered the wrong info. please make sure that you use your real date of birth."
              );
              ...
              setDateError("");
              setGenderError(
                "Please choose a gender. You can chnage who can see this later"
              );
            } else {
              setDateError("");
              setGenderError("");
